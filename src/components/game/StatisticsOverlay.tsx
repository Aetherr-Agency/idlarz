              ...
              <div className='space-y-4'>
                      ...
                      <div key={`modifier-${resource}`} className=''>
                        ...
                        <div className='pl-4 space-y-1'>
                          ...
                          <div className='flex justify-between text-[10px]'>
                            <span className='text-gray-500'>From castle base:</span>
                          ...
                          <div className='flex justify-between text-[10px]'>
                            <span className='text-gray-500'>From biome tiles:</span>
                            <span className='text-blue-200'>
                              {formatRate(
                                baseValue -
                                  (CASTLE_BASE_RATES[
                ...
                <div className='mt-4 border-t border-gray-700 pt-3'>
                  ...
                  <div className='pl-2 space-y-1 text-[11px]'>
                    ...
                    <div className='flex justify-between'>
                      <span className='text-gray-400'>Doubling per level:</span>
